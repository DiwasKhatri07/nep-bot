...
export const botProfiles = mysqlTable("bot_profiles", {
  ...
  language: mysqlEnum("language", ["en", "ne"]).default("ne").notNull(),
...
export const botFeatureSettings = mysqlTable("bot_feature_settings", {
  ...
  antiCallReplyMode: mysqlEnum("antiCallReplyMode", ["localized", "silent"]).default("localized").notNull(),
  ...
  leaveMessage: boolean("leaveMessage").default(false).notNull(),
  antiLinkWarn: boolean("antiLinkWarn").default(false).notNull(),
  privateAutoReply: boolean("privateAutoReply").default(false).notNull(),
  statusView: boolean("statusView").default(false).notNull(),
  statusReply: boolean("statusReply").default(false).notNull(),
